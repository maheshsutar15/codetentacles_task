...
export default function Header() {
    ...
    return (
        <>
                    ...
                    <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center">
                            <div className="flex items-center ms-3">
                                <div>
                                    <button type="button" onClick={()=>setOpen(true)} className="flex text-sm bg-gray-800 rounded-full focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600" aria-expanded="false" data-dropdown-toggle="dropdown-user">
            ...
            <Modal
                title={"Are you sure wanted to logout this user?"}
                isOpen={open} onClose={()=>{setOpen(false)}} SuccessBtnTitle={"Logout"}
